# -*- coding: utf-8 -*-
"""
Assignment 3 - Mesh Convergence Study - C_D (accuracy) comparison 
...
# Plot C_D versus num_y

fig, ax = plt.subplots()
ax.plot(num_y_values, C_D_values, marker='o')
ax.set_xlabel('num_y')
ax.set_ylabel('C_D')
ax.set_title('Variation of C_D with num_y')
plt.show()